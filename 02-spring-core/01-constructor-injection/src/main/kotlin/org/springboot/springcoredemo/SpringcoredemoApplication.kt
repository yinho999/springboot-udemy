...
/*
 * @SpringBootApplication(scanBasePackages = ["org.springboot.springcoredemo", "org.springboot.util"]): Tells Spring Boot to look for other components, configurations, and services in the org.springboot.springcoredemo package, letting it find the controllers.
 */
